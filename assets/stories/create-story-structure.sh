...
echo "📄 Story data template: $STORY_DIR/story-data.json"
echo ""
echo "Next steps:"
echo "1. Add your WebP images to the appropriate directories"
echo "2. Update the story-data.json with your actual story content"
echo "3. Test the story in your app"
