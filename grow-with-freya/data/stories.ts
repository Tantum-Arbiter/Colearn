...
// Reading challenge stories - local bundled stories adapted from the wombat story
// for spelling (spell_word) and word-placing (fill_in_blank) learning modes
export const READING_CHALLENGE_STORIES: Story[] = [
  // Spelling story - uses spell_word reading challenges
  {
    id: 'wombat-spelling',
    title: 'Wombat Spelling Adventure',
    localizedTitle: {
      en: 'Wombat Spelling Adventure',
      pl: 'Wombat - Przygoda z Literowaniem',
      es: 'Wombat - Aventura de Deletreo',
      de: 'Wombat - Buchstabier-Abenteuer',
      fr: 'Wombat - Aventure d\'Orthographe',
      it: 'Wombat - Avventura di Compitazione',
      pt: 'Wombat - Aventura de Soletração',
      ja: 'ウォンバット スペリングアドベンチャー',
      ar: 'مغامرة تهجئة الومبت',
      tr: 'Wombat Heceleme Macerası',
      nl: 'Wombat Spel Avontuur',
      da: 'Wombat Stave Eventyr',
      la: 'Wombatus Aventura Litterationis',
      zh: '袋熊拼写冒险',
    },
    category: 'learning',
    coverImage: require('../assets/stories/snuggle-little-wombat/cover/cover-large.webp'),
    ...
    localizedDescription: {
      ...
      pl: 'Pomóż Wombatowi literować słowa w przygodzie przed snem!',
      es: '¡Ayuda a Wombat a deletrear palabras en una aventura nocturna!',
      de: 'Hilf Wombat, Wörter in einem Gute-Nacht-Abenteuer zu buchstabieren!',
      fr: 'Aide Wombat à épeler des mots dans une aventure du coucher!',
      it: 'Aiuta Wombat a compitare parole in un\'avventura della buonanotte!',
      pt: 'Ajude Wombat a soletrar palavras em uma aventura de dormir!',
      ja: 'ウォンバットのおやすみ冒険で言葉をつづろう！',
      ar: 'ساعد الومبت في تهجئة الكلمات في مغامرة وقت النوم!',
      tr: 'Wombat\'a uyku macerası sırasında kelimeleri hecelemeye yardım et!',
      nl: 'Help Wombat woorden te spellen in een slaaptijd avontuur!',
      da: 'Hjælp Wombat med at stave ord i et godnat eventyr!',
      la: 'Adiuva Wombatum verba litterare in aventura somni!',
      zh: '帮助袋熊在睡前冒险中拼写单词！',
    },
    tags: ['learning', 'animals', 'bedtime'],
    pages: [
      {
        id: 'wombat-spelling-cover',
        pageNumber: 0,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/cover/cover-large.webp'),
        text: 'Wombat Spelling Adventure',
        localizedText: { '4-6': {
          en: 'Wombat Spelling Adventure',
          pl: 'Wombat - Przygoda z Literowaniem',
          es: 'Wombat - Aventura de Deletreo',
      ...
      },
      {
        ...
        interactionType: 'reading_challenge',
        readingChallenge: {
          enabled: true,
          mode: 'spell_word',
          promptText: 'Can you spell this word?',
          allowSkip: true,
          targetWord: 'STARS',
          distractorLetters: ['X', 'Z', 'Q'],
        },
      },
      {
        id: 'wombat-spelling-2',
        pageNumber: 2,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/page-3/background.webp'),
        text: 'Wombat walked, the stars shined through, looking for a nest, that\'s warm and new.',
        localizedText: { '4-6': {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'spell_word',
          promptText: 'Spell this word!',
          allowSkip: true,
          targetWord: 'WARM',
          distractorLetters: ['X', 'Z'],
        },
      },
      {
        id: 'wombat-spelling-3',
        pageNumber: 3,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/page-5/background.webp'),
        text: 'Wombat stopped, where soft roots grew, inside the burrow, the quietness grew.',
        localizedText: { '4-6': {
      ...
      },
      {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'spell_word',
          promptText: 'One last word to spell!',
          allowSkip: true,
          targetWord: 'NIGHT',
          distractorLetters: ['X', 'Z'],
        },
  ...
  // Word-placing story - uses fill_in_blank reading challenges
  {
    id: 'wombat-word-placing',
    title: 'Wombat Word Adventure',
    localizedTitle: {
      en: 'Wombat Word Adventure',
      pl: 'Wombat - Przygoda ze Słowami',
      es: 'Wombat - Aventura de Palabras',
      de: 'Wombat - Wort-Abenteuer',
      fr: 'Wombat - Aventure de Mots',
      it: 'Wombat - Avventura di Parole',
      pt: 'Wombat - Aventura de Palavras',
      ja: 'ウォンバット ことばアドベンチャー',
      ar: 'مغامرة كلمات الومبت',
      tr: 'Wombat Kelime Macerası',
      nl: 'Wombat Woorden Avontuur',
      da: 'Wombat Ord Eventyr',
      la: 'Wombatus Aventura Verborum',
      zh: '袋熊词语冒险',
    },
    category: 'learning',
    coverImage: require('../assets/stories/snuggle-little-wombat/cover/cover-large.webp'),
    ...
    localizedDescription: {
      ...
      pl: 'Pomóż Wombatowi znaleźć brakujące słowa!',
      es: '¡Ayuda a Wombat a encontrar las palabras que faltan!',
      de: 'Hilf Wombat, die fehlenden Wörter zu finden!',
      fr: 'Aide Wombat à trouver les mots manquants!',
      it: 'Aiuta Wombat a trovare le parole mancanti!',
      pt: 'Ajude Wombat a encontrar as palavras que faltam!',
      ja: 'ウォンバットの足りない言葉を見つけよう！',
      ar: 'ساعد الومبت في إيجاد الكلمات المفقودة!',
      tr: 'Wombat\'a eksik kelimeleri bulmaya yardım et!',
      nl: 'Help Wombat de ontbrekende woorden te vinden!',
      da: 'Hjælp Wombat med at finde de manglende ord!',
      la: 'Adiuva Wombatum verba deesse invenire!',
      zh: '帮助袋熊找到缺失的单词！',
    },
    tags: ['learning', 'animals', 'bedtime'],
    pages: [
      {
        id: 'wombat-word-placing-cover',
        pageNumber: 0,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/cover/cover-large.webp'),
        text: 'Wombat Word Adventure',
        localizedText: { '4-6': {
          en: 'Wombat Word Adventure',
          pl: 'Wombat - Przygoda ze Słowami',
          es: 'Wombat - Aventura de Palabras',
      ...
      },
      {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'fill_in_blank',
          promptText: 'Can you fill in the missing words?',
          allowSkip: true,
          blankWordIndices: [1, 4, 11],
        },
      },
      {
        id: 'wombat-word-placing-2',
        pageNumber: 2,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/page-4/background.webp'),
        text: 'Wombat smiled, a burrow in view, time to rest, and dream things new.',
        localizedText: { '4-6': {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'fill_in_blank',
          promptText: 'Which words are missing?',
          allowSkip: true,
          blankWordIndices: [1, 3, 10],
        },
      },
      {
        id: 'wombat-word-placing-3',
        pageNumber: 3,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/page-6/background.webp'),
        text: 'Wombat nests, the night time grew, sleeping in a bed, where dreams come true.',
        localizedText: { '4-6': {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'fill_in_blank',
          promptText: 'Fill in the missing words!',
          allowSkip: true,
          blankWordIndices: [1, 5, 10],
        },
      },
      {
        id: 'wombat-word-placing-4',
        pageNumber: 4,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/page-7/background.webp'),
        text: 'Wombat dreamt, with gentle cheer, hugging berries he held so dear.',
        localizedText: { '4-6': {
        ...
        readingChallenge: {
          enabled: true,
          mode: 'fill_in_blank',
          promptText: 'One last set of words to place!',
          allowSkip: true,
          blankWordIndices: [1, 4, 6],
        },
      },
    ]
  } as Story,
