...
// Jigsaw Puzzle story - local bundled story with jigsaw interactive pages
export const JIGSAW_STORIES: Story[] = [
  {
    id: 'wombat-jigsaw-adventure',
    title: 'Wombat Jigsaw Adventure',
    localizedTitle: {
      en: 'Wombat Jigsaw Adventure',
      pl: 'Przygoda z Puzzlami Wombata',
      es: 'Aventura Rompecabezas de Wombat',
      de: 'Wombat Puzzle-Abenteuer',
      fr: 'Aventure Puzzle de Wombat',
      it: 'Avventura Puzzle di Wombat',
      pt: 'Aventura Quebra-Cabeça do Wombat',
      ja: 'ウォンバットジグソーアドベンチャー',
      ar: 'مغامرة لغز الومبت',
      tr: 'Wombat Yapboz Macerası',
      nl: 'Wombat Puzzel Avontuur',
    ...
    localizedDescription: {
      ...
      pl: 'Pomóż Wombatowi rozwiązując puzzle! Zamieniaj kafelki, aby odtworzyć każdy obrazek.',
      es: '¡Ayuda a Wombat resolviendo rompecabezas! Intercambia las piezas para reconstruir cada imagen.',
      de: 'Hilf Wombat beim Lösen von Puzzles! Tausche die Kacheln, um jedes Bild wiederherzustellen.',
      fr: 'Aidez Wombat en résolvant des puzzles ! Échangez les tuiles pour reconstruire chaque image.',
      it: 'Aiuta Wombat risolvendo puzzle! Scambia le tessere per ricostruire ogni immagine.',
      pt: 'Ajude o Wombat resolvendo quebra-cabeças! Troque as peças para reconstruir cada imagem.',
      ja: 'ウォンバットを助けてジグソーパズルを解こう！タイルを入れ替えて写真を完成させよう。',
      ar: 'ساعد الومبت في حل الألغاز! بدّل القطع لإعادة بناء كل صورة.',
      tr: 'Yapbozları çözerek Wombat\'a yardım edin! Her resmi yeniden oluşturmak için karoları değiştirin.',
      nl: 'Help Wombat door puzzels op te lossen! Wissel de tegels om elk plaatje te herstellen.',
      da: 'Hjælp Wombat ved at løse puslespil! Byt brikkerne for at genopbygge hvert billede.',
      la: 'Adiuva Wombatum solvendo aenigmata! Commuta tesseras ut imagines reconstruas.',
      zh: '通过解决拼图来帮助袋熊！交换拼块来重建每张图片。',
    },
    tags: ['adventure', 'puzzle', 'interactive'],
    pages: [
      {
        id: 'wombat-jigsaw-cover',
        pageNumber: 0,
        backgroundImage: require('../assets/stories/snuggle-little-wombat/cover/cover-large.webp'),
      ...
      },
      {
        ...
        localizedText: {
          ...
          de: 'Wombats Bild wurde durcheinander gebracht! Kannst du es wieder zusammensetzen?',
          fr: 'L\'image de Wombat s\'est mélangée ! Peux-tu la remettre en ordre ?',
          it: 'L\'immagine di Wombat si è mescolata! Riesci a ricomporla?',
          pt: 'A imagem do Wombat se misturou! Você consegue montá-la?',
          ja: 'ウォンバットの写真がバラバラになっちゃった！元に戻せるかな？',
          ar: 'اختلطت صورة الومبت! هل يمكنك إعادة تجميعها؟',
          tr: 'Wombat\'ın resmi karıştı! Tekrar birleştirebilir misin?',
          nl: 'Wombats plaatje is door elkaar geraakt! Kun je het weer in elkaar zetten?',
      ...
      },
      {
        ...
        localizedText: {
          ...
          de: 'Dieses ist etwas schwieriger! Kannst du das größere Puzzle lösen?',
          fr: 'Celui-ci est un peu plus difficile ! Peux-tu résoudre le plus grand puzzle ?',
          it: 'Questo è un po\' più difficile! Riesci a risolvere il puzzle più grande?',
          pt: 'Este é um pouco mais difícil! Você consegue resolver o quebra-cabeça maior?',
          ja: 'これはちょっと難しいよ！大きなパズルを解けるかな？',
          ar: 'هذا أصعب قليلاً! هل يمكنك حل اللغز الأكبر؟',
          tr: 'Bu biraz daha zor! Daha büyük yapbozu çözebilir misin?',
          nl: 'Deze is een beetje lastiger! Kun je de grotere puzzel oplossen?',
      ...
      },
      {
        ...
        localizedText: {
          ...
          de: 'Die ultimative Herausforderung! Schaffst du das schwierigste Puzzle?',
          fr: 'Le défi ultime ! Peux-tu maîtriser le puzzle le plus difficile ?',
          it: 'La sfida definitiva! Riesci a padroneggiare il puzzle più difficile?',
          pt: 'O desafio final! Você consegue dominar o quebra-cabeça mais difícil?',
          ja: '究極のチャレンジ！最も難しいパズルをマスターできるかな？',
          ar: 'التحدي الأقصى! هل يمكنك إتقان أصعب لغز؟',
          tr: 'En büyük meydan okuma! En zor yapbozu çözebilir misin?',
          nl: 'De ultieme uitdaging! Kun je de moeilijkste puzzel meester worden?',
