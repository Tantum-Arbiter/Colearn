...
const STEP_ICONS: Record<string, IoniconsName> = {
  emotion_cards_welcome: 'heart-circle-outline',
  emotion_cards_together: 'people-outline',
  emotion_cards_connect: 'bulb-outline',
  emotion_cards_scenarios: 'game-controller-outline',
  emotion_cards_themes: 'color-palette-outline',
};
          ...
          <Animated.View style={[styles.card, landscapeCardStyle, animatedCardStyle]}>
            {currentTip.image ? (
              ...
              <View style={styles.iconContainer}>
                <Ionicons name={STEP_ICONS[currentTip.id] || 'heart-circle-outline'} size={36} color="#4ECDC4" />
              </View>
            )}
