...
import { STORY_MODES_TOUR_STEPS, TutorialStepWithKeys } from './tutorial-content';
...
/**
 * Story Mode Tips Overlay - Shows guidance about Interactive, Musical & Jigsaw modes
 * on first visit to the mode cards screen.
 */
export function StoryModeTipsOverlay({ isActive, onClose }: StoryModeTipsOverlayProps) {
  ...
  const steps: TutorialStepWithKeys[] = STORY_MODES_TOUR_STEPS;
...
const styles = StyleSheet.create({
  ...
  nextText: { fontSize: 14, fontFamily: Fonts.sans, fontWeight: '700' as const, color: '#fff', marginRight: 4 },
});
