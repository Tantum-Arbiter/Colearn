...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 bg-gradient-brand relative overflow-hidden">
      {/* Background texture */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          <h2 className="font-rounded text-3xl sm:text-4xl font-bold text-white mb-4">
            {t.testimonials.title} <span className="text-brand-teal">{t.testimonials.titleHighlight}</span> {t.testimonials.titleEnd}
          </h2>
