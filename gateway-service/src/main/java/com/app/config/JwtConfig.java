...
public class JwtConfig {
     ...
     */
    public DecodedJWT validateGoogleIdToken(String idToken, String clientId) throws JWTVerificationException {
        try {
            ...
            // Create verifier with Google's public key
     ...
     */
    public DecodedJWT validateAppleIdToken(String idToken, String clientId) throws JWTVerificationException {
        try {
            // Decode token header to get key ID
            DecodedJWT decodedJWT = JWT.decode(idToken);
            String keyId = decodedJWT.getKeyId();
            ...
            // Create verifier with Apple's public key
            Algorithm algorithm = Algorithm.RSA256(publicKey, null);
            JWTVerifier verifier = JWT.require(algorithm)
